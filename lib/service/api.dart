...
class APIServices {
  static Future<dynamic> postDataRequest({
    String? type,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return errorResponse!({'errorType': 'Forbidden'});
        ...
        return errorResponse!(
            {'errorType': 'Something went wrong! 〧 ${response.statusCode} ┦'});
      }
